...
class FirebaseConnectionTest:
    ...
    def test_credentials_file(self):
        ...
        if not os.path.exists(self.credentials_path):
            ...
            self.print_test(
                "Credentials file exists",
                True,
                f"Found at: {self.credentials_path}"
            )
    ...
    def test_database_write_permission(self):
        ...
        try:
            ...
            if read_data and isinstance(read_data, dict) and read_data.get('message') == test_data['message']:
                self.print_test(
    ...
    def print_summary(self):
        ...
        if self.failed_tests == 0:
            print(colored("✓ All tests passed! Firebase is ready to use.", 'green', attrs=['bold']))
        else:
            print(colored("✗ Some tests failed. Please check the configuration.", 'red', attrs=['bold']))
