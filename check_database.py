...
def add_test_data():
    ...
    test_posts = [
        ...
        },
        {
            ...
            'content': '<p>To import your notes, click the "Import ENEX File" button and select your exported Evernote file.</p>',
        ...
        },
        {
            ...
            'content': '<p>Your creative ideas, sketches, and notes will appear here in a beautiful masonry grid layout.</p>',
